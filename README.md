# Using SVG Sprites and More

These are the slides for my 8/20/2014 talk on Using SVG Sprites at the [NYCHTML5 meetup](http://nychtml5.com).

Sides are based on the Google IO HTML5 Slide Template. Details on installation and usage are below:
